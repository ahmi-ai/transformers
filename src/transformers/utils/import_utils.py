...
def is_torch_musa_available(check_device=False) -> bool:
    ...
    """
    Simply try to "import" torch_musa instead of using _is_package_available" to avoid torch.compile errors.
    """
    try:
        import torch
        ...
        """
        fixme: torch.musa.is_available() will cause errors when torch is compiling.
        """
